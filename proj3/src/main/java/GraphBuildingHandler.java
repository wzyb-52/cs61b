...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private Queue<Long> wayNodes;
    private boolean ifValidWay;
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            activeState = "way";
            /** Other initialization of way. */
            wayNodes = new LinkedList<>();
            // The id is not a Node!
            // wayNodes.add(Long.parseLong(attributes.getValue("id")));
            ifValidWay = false;
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            lastNode.locationName = attributes.getValue("name");
        }
    }
...
//            System.out.println("Finishing a way...");
            if (ifValidWay) {
                long lastID = wayNodes.remove(), currID;
                while (!wayNodes.isEmpty()) {
                    currID = wayNodes.remove();
                    g.connect(lastID, currID);
                    lastID = currID;
                }
            }
        }
